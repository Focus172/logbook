    ...
    var body: some View {
        NavigationView {
            VStack {
                ...
                Button {
                    dataManager.addActivity(date: dateOfRun, author: settings.userName, milage: Double(distanceRan), pain: Double(painLevel), postComment: postComment, feelingComment: feelingComment, publiclyVisible: publicalyVisible)
